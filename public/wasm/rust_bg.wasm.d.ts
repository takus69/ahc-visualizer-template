...
export function __wbg_get_ret_before_comment(a: number, b: number): void;
export function __wbg_set_ret_before_comment(a: number, b: number, c: number): void;
export function __wbg_get_ret_after_comment(a: number, b: number): void;
export function __wbg_set_ret_after_comment(a: number, b: number, c: number): void;
